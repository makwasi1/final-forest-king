"use client"
import { ForestThemeToggle } from "./forest-theme-toggle"
...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-forest-100 dark:border-forest-800 bg-white/90 dark:bg-forest-950/90 backdrop-blur-sm">
      <div className="container flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          <Notifications />
          {/* Replace ThemeToggle with ForestThemeToggle */}
          <ForestThemeToggle />
          <DropdownMenu>
