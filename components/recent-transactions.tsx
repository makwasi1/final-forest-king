...
export function RecentTransactions() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg font-medium">Recent Forest Activities</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <Button
          ...
          variant="outline"
          className="border-forest-200 dark:border-forest-800 hover:bg-forest-50 dark:hover:bg-forest-900"
        >
          View All Forest Activities
        </Button>
      </CardContent>
    </Card>
  )
